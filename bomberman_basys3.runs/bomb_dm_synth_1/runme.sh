...
HD_PWD='C:/everything/college/UCF stuff/Year 5 term 1/FPGA Design Labs/FPGA final project/vivado projects/bomberman_basys3/bomberman_basys3.runs/bomb_dm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bomb_dm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bomb_dm.tcl
