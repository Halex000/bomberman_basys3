...
#
# Generated by export_simulation on Fri Dec 02 07:25:19 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './explosions_br.sh' script.

./explosions_br.sh -reset_run
...
./explosions_br.sh -noclean_files

For more information on the script, please type './explosions_br.sh -help'.
